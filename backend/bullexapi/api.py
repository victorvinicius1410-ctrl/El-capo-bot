...
class BullexAPI(object):  # pylint: disable=too-many-instance-attributes
    ...
    def __init__(self, host, username, password, proxies=None):
        ...
        # Fase 3 / 2026-08-07: TODO estado mutável de classe vira atributo
        # de instância. Antes, dicts/listas/objetos no corpo da classe eram
        # compartilhados por TODAS as sessões do processo (risco WIN/LOSS
        # trocado e candles/profile cruzados). Ver ROBO_E_SUPORTE.md e
        # PERFORMANCE_SISTEMA.md (gate=3 após isolamento).
    ...
    def _websocket_proxy_kwargs(self):
        ...
        if isinstance(self.proxies, dict):
            raw = self.proxies.get("https") or self.proxies.get("http")
        ...
        if parsed.username is not None and parsed.password is not None:
            kwargs["http_proxy_auth"] = (unquote(parsed.username), unquote(parsed.password))
        return kwargs
