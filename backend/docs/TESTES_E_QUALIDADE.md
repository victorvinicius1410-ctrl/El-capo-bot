...
**Estado atual: 724 testes nos arquivos de runtime/scan desta rodada; suíte
completa no venv.** Ver canônico `docs/TESTES_E_QUALIDADE.md`.

Em **2026-08-18** testes em `tests/test_runtime_shared_market_cache.py` e
`tests/test_robot_market_data_resilience.py` (ver canônico
`docs/TESTES_E_QUALIDADE.md`).
