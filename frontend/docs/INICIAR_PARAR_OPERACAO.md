...
| `preserveRobotSessionScore` | Start/stop/WS/HTTP **não** trocam um placar vivo por 0-0 (snapshot de controle). Ver `PLACAR_OVERLAY.md` |
...
- `Frontend/src/lib/robotState.ts` — `isRobotOperationRunning`, `preserveRobotSessionScore`
...
- [`PLACAR_OVERLAY.md`](./PLACAR_OVERLAY.md) — placar 0-0 ao iniciar/parar
